...
```
12. The token may be provided with the X-Authorization-Header or as a Bearer token under Authorization, or as a parameter to the URL like ?t=[token]
```
...
I'll leave you with one final thought. If you believe that all of the decisions can be extracted and chosen before code starts to get written, I'm afraid I have some bad news for you. This has never been the case. Code is code because it, and only it, precisely specifies what the computer must do. We didn't eliminate all of the decisions yet to be made in this example, though it might seem like we did.
