...
Now let's look at the impact on the generated prompt...
...
Here is the output schema:
{"properties": {"todos": {"title": "Todos", "description": "A list of ToDos", "type": "array", "items": {"$ref": "#/definitions/ToDo"}}, "title": {"title": "Title", "description": "A title for the ToDo list", "default": "My ToDos", "maxLength": 50, "minLength": 3, "type": "string"}}, "definitions": {"ToDo": {"title": "ToDo", "type": "object", "properties": {"title": {"title": "Title", "description": "A short title for the ToDo", "maxLength": 50, "minLength": 3, "type": "string"}, "description": {"title": "Description", "description": "Details or notes about the ToDo", "type": "string"}, "done": {"title": "Done", "description": "Whether the ToDo is done or not", "default": false, "type": "boolean"}}, "required": ["title", "description"]}}}
